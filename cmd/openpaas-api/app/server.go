...
func (kc *KubetnetesCLient) CreateDeploymentTest() {
	//kc.KubeCtl.Apps().Deployments("test").Create()
...
func Run() {
	...
	//kubecli.GetRC()
	//kubecli.UpdateRC()
	fmt.Println("the openpaas api server is running on 9090")
